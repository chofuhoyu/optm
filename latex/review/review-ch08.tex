...
$X^{(1)} = X^{(0)} + \lambda_0 d^{(0)} = (2,1)^T + \frac{41}{114}(-5,-4)^T = \frac{1}{114}(23,-50)^T$。

$\nabla f^{(1)} = (\frac{2\cdot 23}{114}+1,\ \frac{4\cdot(-50)}{114})^T = (\frac{160}{114},\ \frac{-200}{114})^T = \frac{1}{114}(160,-200)^T$。
...
计算 DFP 各项：
\begin{align*}
s_0^T y_0 &= \left(-\frac{41}{114}\right)^2 (5,4)\cdot(10,16) = \left(\frac{41}{114}\right)^2 \cdot 114 = \frac{41^2}{114} \\
s_0 s_0^T &= \left(\frac{41}{114}\right)^2 \begin{pmatrix}5\\4\end{pmatrix}\begin{pmatrix}5&4\end{pmatrix} = \frac{41^2}{114^2}\begin{pmatrix}25&20\\20&16\end{pmatrix} \\
y_0^T H_0 y_0 &= y_0^T y_0 = \left(\frac{41}{114}\right)^2 (10^2+16^2) = \frac{41^2}{114^2}\cdot 356
\end{align*}
